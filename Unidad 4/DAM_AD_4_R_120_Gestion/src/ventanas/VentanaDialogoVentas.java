...
protected void visualizarventas() {
	...
	try
	 ...
	 textArea.append(" CODVENTA  CODARTI  DENOMINACION            NUMCLI       NOMBRE                        FECHA           UNIVEN       IMPORTE          PRECIOFINAL\n");
	 textArea.append("================================================================================================================================================ \n");
	 ...
	 {   	  
		 ...
		 if (depa.getCodarti()!=null) importe = depa.getUniven() * depa.getCodarti().getPvp();
		 float precioFinal=importe;
		 System.out.println(depa.getNumcli().getDescuento());
	     if(depa.getNumcli().getDescuento()==1) {
	    	 precioFinal=precioFinal*depa.getCodarti().getDescuento()/100;
	     }
	     String patron="%5d \t %5d \t %-15s \t %5d \t %-22s \t %-10s \t %5d \t %8.2f \t %5.2f";
	     System.out.println(depa.getCodarti().getDescuento());
